...
/**
 * The switches `Main` accepts on the command line so that the windows can be photographed on
 ...
 *
 * ```
 * Recly --show-popup --show-settings --theme=dark --high-contrast --lang=ko
 * Recly --show-delete --show-disconnect --show-consent
 * ```
 */
data class DevFlags(
